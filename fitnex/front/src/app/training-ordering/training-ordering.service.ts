...
export class TrainingOrderingService {
	...
	private get url() {
		return this.global.backendURL + '/trainings/orderings'
	}
	...
	save(trainingId: number) {
		return this.http.post(
			this.url,
			"",
			{
				headers: this.global.headersToken,
				params: new HttpParams({}).appendAll({trainingId: trainingId})
			}
		);
	}
